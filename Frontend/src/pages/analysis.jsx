      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between gap-4 mb-2">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <span className="whitespace-nowrap bg-green-100 text-green-600 px-3 py-1 rounded-xl text-sm font-medium flex items-center gap-2 shadow-sm">
              <FaCheckCircle className="text-green-600 text-sm" />
              Supported
            </span>

            <span className="whitespace-nowrap bg-purple-600 text-white px-3 py-1 rounded-full text-xs font-medium">
              Production-grade
            </span>

            <span className="whitespace-nowrap bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-xs">
              README
            </span>
